...
func UpdateTweetVisibility(db *sqlx.DB) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		data, err := decoder.UpdateVisDecoder(r)
		...
		if err := tweets.UpdatePostVisibility(db, data.TweetId, data.Visibility, userData.Id); err != nil {
			encoder.ResponseWriter(w, http.StatusInternalServerError, models.ErrorResponse{
				Status: http.StatusInternalServerError,
				Res: models.Message{
					Message: err.Error(),
